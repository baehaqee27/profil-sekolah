...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.siswa.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">+ Tambah Siswa</a>
    </div>
    @if(session('success'))
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 border flex gap-2">
                        <a href="{{ route('admin.siswa.show', $siswa) }}" class="text-blue-600 hover:underline">Detail</a>
                        <a href="{{ route('admin.siswa.edit', $siswa) }}" class="text-yellow-600 hover:underline">Edit</a>
                        <form action="{{ route('admin.siswa.destroy', $siswa) }}" method="POST" onsubmit="return confirm('Yakin hapus?')" class="inline">
                            @csrf
                            @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="5" class="px-4 py-2 border text-center">Belum ada data siswa.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
